  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Enter the outstanding loan amount for commercial real estate loan calculations
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <Label htmlFor="outstanding-loan">Outstanding Loan Amount (PKR)</Label>
            <FieldTooltip content="How much money is currently owed on the commercial real estate loan" />
          </div>
