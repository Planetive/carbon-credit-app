...
• Leverage CO₂ storage expertise to serve both domestic decarbonization and possible future CO₂ import/export markets (geological capacity + infrastructure). CSIRO has pointed to Australia''s potential to become a CO₂ hub for the region.
...
g. Decarbonizing Hard-to-Abate Industries
...
• Align CCUS deployment with Australia''s Net Zero Plan and sectoral decarbonization strategies: CCUS must become a central part of Australia''s roadmap to net zero by 2050.'
